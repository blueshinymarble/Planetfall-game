...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float screenEdgeBorder = 0.00001f;
        ...
        {
            Transform GameTransform = GameObject.Find("Game").GetComponent<Transform>();
            if (useKeyboardRotation)
...

                {
                   ...
                   //useScreenEdgeInput = false;
                    GameTransform.Rotate(Vector3.up, RotationDirection * Time.deltaTime * rotationSped, Space.World);
                }

            if (Input.GetKeyUp(rotateLeftKey) || (Input.GetKeyUp(rotateRightKey)))
